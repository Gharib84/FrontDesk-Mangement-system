                                                ...
                                                <tr class="bg-white border-b">
                                                    ...
                                                    <td>
                                                        <form action="" method="GET">
                                                            @csrf
                                                            <a  href="{{route('books.show', $book)}}" type="submit" class="inline-block px-6 py-2 border-2 border-green-500 text-green-500 font-bold text-xs leading-tight uppercase rounded-full hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">
                                                                Book</a>
                                                        </form>
                                                    </td>
                                                    <td>
